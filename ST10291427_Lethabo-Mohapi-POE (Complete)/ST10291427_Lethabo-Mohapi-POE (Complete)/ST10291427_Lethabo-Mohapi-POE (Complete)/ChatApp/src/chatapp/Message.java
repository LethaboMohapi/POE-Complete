...
public class Message {
    ...
    /**
     * Alternative constructor for creating messages from JSON data
     * Used when loading stored messages from files
     *
     * @param sender Username of the sender
     * @param recipient Phone number of the recipient
     * @param messageContent Content of the message
     * @param messageNumber The number of this message
     * @param messageID The existing message ID
     * @param messageHash The existing message hash
     * @throws IllegalArgumentException if validation fails
     */
    public Message(String sender, String recipient, String messageContent, int messageNumber, 
                   String messageID, String messageHash) throws IllegalArgumentException {
        // Use existing IDs instead of generating new ones
    ...
    /**
     * Generates a message hash according to specifications: First two numbers
     * of message ID, colon, message number, colon, first and last words of the
     * message
     *
    ...
    public String sentMessage() {
        ...
        switch (choice) {
            ...
            case 2: // Discard Message
                ...
                allMessages.add(this); // Still add to allMessages for tracking
    ...
    private void displayMessageDetails() {
        String details
                ...
                + "Status: " + status + "\n"
                + "Content Length: " + messageContent.length() + " characters\n\n"
                + "Message Content:\n" + messageContent;
